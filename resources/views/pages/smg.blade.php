...
<div class="container ">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center py-5 ">
            ...
            margin-right: auto; " src="{{ asset('files/media/img/smg.png') }}" alt="">
        </div>
    </div>
</div>
...
<div class="container-fluid fixed-bottom">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center animate__animated animate__slideInUp text-white py-3 songtitle"
            ...
            <h5 style="color: red;">STG</h5>
            <p>Ft Mo Bolaji & Niel Eche</p>
            <p style="line-height: 1; font-size:13px;">Wanting to create a summer
                anthem on STG, the duo
                had to put all the elements 
                together, from the beat to
                what would work excellently
                on it, a superb hook, a
                switch rap verse to produce
                a rhythmic tune for the
                summer</p>

            <audio id="bg_audio" autoplay loop>
                <source src="{{ asset('files/media/music/smg.mp3') }}" type="audio/mpeg">
