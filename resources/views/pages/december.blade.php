...
<div class="container ">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center py-5 ">
            ...
            margin-right: auto;" src="{{ asset('files/media/img/december.png') }}" alt="">
        </div>
    </div>
</div>
...
<div class="container-fluid fixed-bottom">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center animate__animated animate__slideInUp text-white py-3 songtitle"
            ...
            <h5 style="color: red;">December</h5>
            <p style="line-height: 1; font-size:13px;">December was recorded
                couple of months after
                selling out his first headline
                show on 16th December
                which was a redefining
                moment to a young musical
                career. A spazzing free flow
                is used to deliver
                breathtaking lyrics that
                centers on the growth and
                perceived greatness.</p>

            <audio id="bg_audio" autoplay loop>
                <source src="{{ asset('files/media/music/december.mp3') }}" type="audio/mpeg">
