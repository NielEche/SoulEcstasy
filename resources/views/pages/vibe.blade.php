...
<div class="container ">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center py-5 d-flex align-self-center ">
            ...
            margin-right: auto; " src="{{ asset('files/media/img/vibe.png') }}" alt="">
        </div>
    </div>
</div>
...
<div class="container fixed-top">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center py-5 ">
            <iframe src="https://giphy.com/embed/5xaOcLRnsWIB0CkfE3u" width="300" height="90" frameBorder="0"
                class="giphy-embed" allowFullScreen></iframe>
            <p><a href="https://giphy.com/gifs/thegifys-5xaOcLRnsWIB0CkfE3u"></a></p>
        </div>
    </div>
</div>
...
<div class="container-fluid fixed-bottom">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center animate__animated animate__slideInUp text-white py-3 songtitle"
            ...
            <h5 style="color: red;">Vibe</h5>
            <p>Ft Correct Boys</p>
            <p style="line-height: 1; font-size:13px;">Just like the title, Vibe was
                made by the vibes
                resonating from the room
                immediately the
                instrumentals kicked in.
                Enjoyable suave flows and
                transitions from verse to
                verse, vibe to vibe </p>

            <audio id="bg_audio" autoplay loop>
                <source src="{{ asset('files/media/music/vibe.mp3') }}" type="audio/mpeg">
