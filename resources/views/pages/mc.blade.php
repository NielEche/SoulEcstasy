...
<div class="container ">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center py-5 ">
            ...
            margin-right: auto; " src="{{ asset('files/media/img/mc.png') }}" alt="">
        </div>
    </div>
</div>
...
<div class="container-fluid fixed-bottom">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center animate__animated animate__slideInUp text-white py-3 songtitle"
            ...
            <h5 style="color: red;">Midnight Chill</h5>
            <p>Ft Saeed</p>
            <p style="line-height: 1; font-size:13px;">Retro hip hop scenarios was
                the picture leading to the
                creation of midnight chills.
                Trizzybeatx produced a
                powerful classic and saeed
                brought in an urban blend to
                complement a tune with
                undeniable cool aura</p>

            <audio id="bg_audio" autoplay loop>
                <source src="{{ asset('files/media/music/mc.mp3') }}" type="audio/mpeg">
