...
<div class="container ">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center py-5 ">
            ...
            margin-right: auto; " src="{{ asset('files/media/img/sippin.png') }}" alt="">
        </div>
    </div>
</div>
...
<div class="container-fluid fixed-bottom">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center animate__animated animate__slideInUp text-white py-3 songtitle"
            ...
            <h5 style="color: red;">Sipping</h5>
            <p>Ft Txby & Mo Bolaji</p>
            <p style="line-height: 1; font-size:13px;">Had a long day? Canʼt wait
                to get home and take a
                quick shower, Sipping some
                liquor and setting the mood
                right for a night with you and
                your lover. The strings-filled
                groovy beat sets the theme
                for Mo Bolaji and Txby to
                infuse their melodies. They
                all move in line with eloquent
                and slow tempo flows.</p>

            <audio id="bg_audio" autoplay loop>
                <source src="{{ asset('files/media/music/sippin.mp3') }}" type="audio/mpeg">
