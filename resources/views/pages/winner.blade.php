...
<div class="container">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center py-5">
            ...
            margin-right: auto; " src="{{ asset('files/media/img/winner.png') }}" alt="">
        </div>
    </div>
</div>
...
<div class="container fixed-top">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center py-5 d-flex align-self-center ">
            <iframe src="https://giphy.com/embed/Y0kYalhMDB9II" width="53" height="220" frameBorder="0"
                class="giphy-embed" allowFullScreen></iframe>
            <p><a href="https://giphy.com/stickers/trophy-Y0kYalhMDB9II"></a></p>
        </div>
    </div>
</div>
...
<div class="container-fluid fixed-bottom">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center animate__animated animate__slideInUp text-white py-3 songtitle"
            ...
            <h5 style="color: red;">Winner</h5>
            <p>Ft Eke Miller & Veen</p>
            <p style="line-height: 1; font-size:13px;">
                On winner, it was a great
                energetic feeling and
                celebration of oozing
                confidence and belief in
                self-ability. Co-produced by
                Kresh maejor, Trap melodies
                weʼre implored and verses
                came in from Canadian
                based Eke Miller and multi
                talented producer and
                rapper Veen to initiate a
                right contrast that fits what
                they wanted to create,
                something lit. </p>

            <audio id="bg_audio" autoplay loop>
                <source src="{{ asset('files/media/music/winner.mp3') }}" type="audio/mpeg">
                Your browser does not support the audio element.
            </audio>
            <div class="col-lg-12 md-12 col-sm-12 col-xs-12">
                <button class="rounded-pill  btn text-white text-center"
                    style="background-color: red; border-color:red !important;" id="playPauseBtn"
